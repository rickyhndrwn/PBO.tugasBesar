 ...
 * @author HNDRWN
 */
public class Scaffolding extends javax.swing.JFrame {

    /**
     * Creates new form Scaffolding
     */
    public Scaffolding() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Scaffolding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scaffolding().setVisible(true);
            }
        });
    }
